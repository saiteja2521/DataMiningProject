...
# Assuming you have your dataset in the same directory as your Jupyter Notebook
...
# Create a bar graph for MAE and RMSE for both training and testing datasets
bar_width = 0.2
